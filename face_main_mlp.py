...
#import image_process_mlp
import time

class video_process():
    def __init__(self, args):
        pass
        #self.image_process = image_process_mlp.image_process(args)
...
def parse_arguments(argv):
    ...
    parse.add_argument('--facenet_and_mlp_meta',type = str, help = 'extract feature in the image',default = 'face_model/face_565_2018_8_26.pb')
    parse.add_argument('--facenet_and_mlp_ckpt',type = str, help = 'classifer through the mlp',default = 'face_model/model.ckpt-37000.pb')
    parse.add_argument('--face_classname_path',type = str, help = 'face classname',default = 'face_model/face_class_name_2018_8_26.txt')
    parse.add_argument('--result_path', type = str, help = 'processed the images saved',default = 'mlp_565_2018_8_26_38k')
